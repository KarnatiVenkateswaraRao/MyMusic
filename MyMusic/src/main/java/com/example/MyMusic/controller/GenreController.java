...
public class GenreController {
    ...
    @GetMapping("/genres")
    public List<Genre> findAllGenres(Model model) {
    ...
    public String handleGenreForm( @ModelAttribute("genre") Genre genre, BindingResult bindingResult) throws SQLException {
